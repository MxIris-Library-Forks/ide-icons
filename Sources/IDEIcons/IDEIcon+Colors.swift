...
extension IDEIconColor {
    public static var allCases: [IDEIconColor] {
        var baseCases: [IDEIconColor] = [
            .monochrome,
            .blue,
            .gray,
            .green,
        ...
        if #available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *) {
            baseCases.append(contentsOf: [.brown, .teal])
        }
        return baseCases
    }
    ...
    public var simpleColor: Color {
        ...
        case .brown: if #available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *) {
            return .brown
        } else {
            fatalError()
        }
        ...
        case .red: return .red
        case .teal: if #available(iOS 15.0, macOS 12.0, tvOS 15.0, watchOS 8.0, *) {
            return .teal
        } else {
            fatalError()
        }
